...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference("Notification.count") do
      post notifications_url, params: { notification: { message: @notification.message, player_id: @notification.player_id } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { message: @notification.message, player_id: @notification.player_id } }
