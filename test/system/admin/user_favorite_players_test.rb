...
class Admin::UserFavoritePlayersTest < ApplicationSystemTestCase
  setup do
    @admin_user_favorite_player = admin_user_favorite_players(:one)
  end

  test "visiting the index" do
    visit admin_user_favorite_players_url
  ...
  test "should update User favorite player" do
    visit admin_user_favorite_player_url(@admin_user_favorite_player)
